...
<html lang="en">
   <head>
      ...
      <title><?php echo isset($title) ? $title : '';?> :: <?php if(isset($site_settings->site_title) && $site_settings->site_title != "") echo $site_settings->site_title;else echo "Benlinks ";?></title>
